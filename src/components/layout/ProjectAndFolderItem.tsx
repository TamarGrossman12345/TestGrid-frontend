    ...
    <Box sx={{ mb: 0.5 }}>
      <ListItemButton
        ...
        sx={{
          borderRadius: 2,
          p: 0.5,
          "&:hover .action-btns": { opacity: 1, visibility: "visible" },
        }}
      >
        ...
        <Box
          ...
          sx={{ opacity: 0, visibility: "hidden", transition: "0.2s" }}
        >
          <IconButton
            size="small"
            onClick={(e) => {
          ...
          {project.files?.map((file) => (
            <ListItemButton
              ...
              sx={{
                borderRadius: 2,
                py: 0.5,
                "&:hover .del-btn": { opacity: 1, visibility: "visible" },
              }}
            >
              ...
              <ListItemText
                primary={file.name}
                slotProps={{
                  primary: { fontSize: "0.9rem", color: "text.secondary" },
                }}
              />
              <IconButton
                className="del-btn"
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  onDeleteFolder(file.TestFileId);
                }}
                sx={{
                  opacity: 0,
                  visibility: "hidden",
